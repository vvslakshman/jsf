...
public class MasterReponse {
    ...
    @SerializedName("data")
    @Expose
    private List<EvenListResponse> data = null;
    ...
    public List<EvenListResponse> getData() {
        return data;
    }

    public void setData(List<EvenListResponse> data) {
        this.data = data;
    }

    public static class EvenListResponse {
